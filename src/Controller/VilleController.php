...
class VilleController extends AbstractController
{
     ...
     */
    public function edit(Request $request, Ville $ville, VillesRepository $villesRepository): Response
    {
        $form = $this->createForm(VilleType::class, $ville);
        $form->handleRequest($request);
     ...
     */
    public function delete(Request $request, Ville $ville, VillesRepository $villesRepository): Response
    {
        if ($this->isCsrfTokenValid('delete'.$ville->getId(), $request->request->get('_token'))) {
            $villesRepository->remove($ville);
        }
